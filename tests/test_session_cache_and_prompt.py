...
class TestSessionCacheAndPrompt(unittest.TestCase):
    ...
    def test_deterministic_guards_never_bypassed_by_poisoned_cache(self):
        ...
        safe, reason, layer, tax = audit_shell_command_with_taxonomy(danger_cmd, cwd="/", scope="w1:p1", agent_id="agent")
    ...
    def test_true_lru_eviction(self):
        ...
        from guard_db import set_cached_evaluation, get_cached_evaluation, _MAX_MEMORY_CACHE_SIZE
        clear_session_cache()
