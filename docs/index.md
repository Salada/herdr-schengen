...
| [ADR-008](adr/adr-008-opencode-alternative-host-runtime.md) | Superseded | OpenCode as alternative host runtime (agent-agnostic governance). | `opencode/plugins/schengen-host.js`, `scripts/cmd/schengen_watcher.py` |
| [ADR-009](adr/adr-009-smartgate-tui-dual-model-and-fifo-governance.md) | Evolved | SmartGate TUI, dual-model phase routing, strict FIFO escalation. | `scripts/cmd/schengen_tui.py`, `scripts/tools/schengen_agent_llm.py`, `scripts/tools/schengen_inspector.py` |
...
| [ADR-018](adr/adr-018-installer-crash-recovery.md) | Active | Target-scoped locking and deterministic recovery from interrupted runtime activation. | `scripts/cmd/schengen_install.py` |
